...
const ManageAdmin = () => {
  const { employees, setEmployees, user, token } = useStore();
      ...
      <div className="user-container">
        {employees.length &&
          employees.map((employee) => (
            <div
              key={employee._id}
              className="m-3 hover:shadow-2xl bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
            >
